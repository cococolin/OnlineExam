			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
						...
						<img class="img-circle" src="images/reception/index.png" alt="Photo" style="width: 30px; height: 30px;" />
							 ...
							 <a class="navbar-brand" href="index.jsp">易卷</a>
						</div>
